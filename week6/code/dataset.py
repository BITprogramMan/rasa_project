...
class Turn:
    def __init__(self,  transcript, turn_label, belief_state, system_acts, system_transcript, asr=None,
                 num=None):
        self.id = turn_id
...
class Dialogue:
    ...
    @classmethod
    def from_dict(cls, d, dialogue_id):
        return cls(dialogue_id, Turn.from_dict(d))
...
class Dataset:
    ...
    @classmethod
    def from_dict(cls, d):
        return cls([Dialogue.from_dict(dd, dialogue_id) for dialogue_id, dd in d.items()])
